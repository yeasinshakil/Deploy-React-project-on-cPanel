    ...
    return (
        <div className=' flex flex-col justify-between'>
            ...
            '>
                ...
                <div>
                    <h1 className=' text-xl font-medium text-primary-dark'>{name}</h1>
                    <p className=' text-sm text-primary-dark'>{post}</p>
                </div>
            </div>
        </div>
    );
